...
public class StellaField extends AreaOfEffect {
    ...
    public StellaField(GamePanel gp, SkillImageProcessor sip) {
        super(gp);
        this.sip = sip;
    }
    ...
    public void set(int worldX, int worldY, Character caster, int damage) {
        ...
        this.durationCounter = 600; // 10 giây * 60 FPS = 600 frames
        this.damageTickCounter = 60; // Gây sát thương mỗi giây (60 frames)
        this.radius = gp.getTileSize() * 5; // Bán kính là 2 ô tile
