...
public class AssetSetter {
    ...
    private void setMap0_Monsters() {
        ...
        gp.getMON_GreenSlime()[0].setWorldX(gp.getTileSize() * 43);
        gp.getMON_GreenSlime()[0].setWorldY(gp.getTileSize() * 86);

        gp.getMON_GreenSlime()[1] = new MON_GreenSlime(gp);
        gp.getMON_GreenSlime()[1].setWorldX(gp.getTileSize() * 33);
        gp.getMON_GreenSlime()[1].setWorldY(gp.getTileSize() * 91);

        gp.getMON_GreenSlime()[2] = new MON_GreenSlime(gp);
        gp.getMON_GreenSlime()[2].setWorldX(gp.getTileSize() * 31);
        gp.getMON_GreenSlime()[2].setWorldY(gp.getTileSize() * 67);

        gp.getMON_GreenSlime()[3] = new MON_GreenSlime(gp);
        gp.getMON_GreenSlime()[3].setWorldX(gp.getTileSize() * 44);
        gp.getMON_GreenSlime()[3].setWorldY(gp.getTileSize() * 63);

        gp.getMON_GreenSlime()[4] = new MON_GreenSlime(gp);
        gp.getMON_GreenSlime()[4].setWorldX(gp.getTileSize() * 12);
        gp.getMON_GreenSlime()[4].setWorldY(gp.getTileSize() * 42);

        gp.getMON_GreenSlime()[5] = new MON_GreenSlime(gp);
        gp.getMON_GreenSlime()[5].setWorldX(gp.getTileSize() * 22);
        gp.getMON_GreenSlime()[5].setWorldY(gp.getTileSize() * 46);

        gp.getMON_GreenSlime()[6] = new MON_GreenSlime(gp);
        gp.getMON_GreenSlime()[6].setWorldX(gp.getTileSize() * 41);
        gp.getMON_GreenSlime()[6].setWorldY(gp.getTileSize() * 37);

        gp.getMON_GreenSlime()[7] = new MON_GreenSlime(gp);
        gp.getMON_GreenSlime()[7].setWorldX(gp.getTileSize() * 56);
        gp.getMON_GreenSlime()[7].setWorldY(gp.getTileSize() * 31);

        gp.getMON_GreenSlime()[8] = new MON_GreenSlime(gp);
        gp.getMON_GreenSlime()[8].setWorldX(gp.getTileSize() * 73);
        gp.getMON_GreenSlime()[8].setWorldY(gp.getTileSize() * 25);

        gp.getMON_GreenSlime()[9] = new MON_GreenSlime(gp);
        gp.getMON_GreenSlime()[9].setWorldX(gp.getTileSize() * 83);
        gp.getMON_GreenSlime()[9].setWorldY(gp.getTileSize() * 35);

        gp.getMON_Bat()[0] = new MON_Bat(gp);
        gp.getMON_Bat()[0].setWorldX(gp.getTileSize()*35);
        gp.getMON_Bat()[0].setWorldY(gp.getTileSize()*35);

        gp.getMON_Bat()[1] = new MON_Bat(gp);
        gp.getMON_Bat()[1].setWorldX(gp.getTileSize()*9);
        gp.getMON_Bat()[1].setWorldY(gp.getTileSize()*51);

        gp.getMON_Bat()[2] = new MON_Bat(gp);
        gp.getMON_Bat()[2].setWorldX(gp.getTileSize()*4);
        gp.getMON_Bat()[2].setWorldY(gp.getTileSize()*29);

        gp.getMON_Bat()[3] = new MON_Bat(gp);
        gp.getMON_Bat()[3].setWorldX(gp.getTileSize()*53);
        gp.getMON_Bat()[3].setWorldY(gp.getTileSize()*33);

        gp.getMON_Bat()[4] = new MON_Bat(gp);
        gp.getMON_Bat()[4].setWorldX(gp.getTileSize()*67);
        gp.getMON_Bat()[4].setWorldY(gp.getTileSize()*39);

        gp.getSkeletonLord()[0] = new MON_SkeletonLord(gp);
        gp.getSkeletonLord()[0].setWorldX(gp.getTileSize() * 49);
        gp.getSkeletonLord()[0].setWorldY(gp.getTileSize() * 91);
    ...
    private void setMap1_Monsters() {
        ...
        gp.getMON_GolemBoss()[0].setWorldX(gp.getTileSize() * 36);
        gp.getMON_GolemBoss()[0].setWorldY(gp.getTileSize() * 90);

        gp.getMON_GolemBoss()[1] = new MON_GolemBoss(gp);
        gp.getMON_GolemBoss()[1].setWorldX(gp.getTileSize() * 10);
        gp.getMON_GolemBoss()[1].setWorldY(gp.getTileSize() * 25);

        gp.getMON_Bat()[0] = new MON_Bat(gp);
        gp.getMON_Bat()[0].setWorldX(gp.getTileSize()*26);
        gp.getMON_Bat()[0].setWorldY(gp.getTileSize()*45);

        gp.getMON_Bat()[1] = new MON_Bat(gp);
        gp.getMON_Bat()[1].setWorldX(gp.getTileSize()*26);
        gp.getMON_Bat()[1].setWorldY(gp.getTileSize()*43);

        gp.getMON_Bat()[2] = new MON_Bat(gp);
        gp.getMON_Bat()[2].setWorldX(gp.getTileSize()*36);
        gp.getMON_Bat()[2].setWorldY(gp.getTileSize()*56);

        gp.getMON_Bat()[3] = new MON_Bat(gp);
        gp.getMON_Bat()[3].setWorldX(gp.getTileSize()*19);
        gp.getMON_Bat()[3].setWorldY(gp.getTileSize()*72);

        gp.getMON_Bat()[4] = new MON_Bat(gp);
        gp.getMON_Bat()[4].setWorldX(gp.getTileSize()*30);
        gp.getMON_Bat()[4].setWorldY(gp.getTileSize()*72);

        gp.getMON_Orc()[0] = new MON_Orc(gp);
        gp.getMON_Orc()[0].setWorldX(gp.getTileSize()*19);
        gp.getMON_Orc()[0].setWorldY(gp.getTileSize()*22);

        gp.getMON_Orc()[1] = new MON_Orc(gp);
        gp.getMON_Orc()[1].setWorldX(gp.getTileSize()*38);
        gp.getMON_Orc()[1].setWorldY(gp.getTileSize()*14);

        gp.getMON_Orc()[2] = new MON_Orc(gp);
        gp.getMON_Orc()[2].setWorldX(gp.getTileSize()*5);
        gp.getMON_Orc()[2].setWorldY(gp.getTileSize()*25);

        gp.getMON_Orc()[3] = new MON_Orc(gp);
        gp.getMON_Orc()[3].setWorldX(gp.getTileSize()*19);
        gp.getMON_Orc()[3].setWorldY(gp.getTileSize()*22);

        gp.getMON_Orc()[4] = new MON_Orc(gp);
        gp.getMON_Orc()[4].setWorldX(gp.getTileSize()*57);
        gp.getMON_Orc()[4].setWorldY(gp.getTileSize()*51);

        gp.getMON_Orc()[5] = new MON_Orc(gp);
        gp.getMON_Orc()[5].setWorldX(gp.getTileSize()*77);
        gp.getMON_Orc()[5].setWorldY(gp.getTileSize()*45);

        gp.getMON_Orc()[6] = new MON_Orc(gp);
        gp.getMON_Orc()[6].setWorldX(gp.getTileSize()*89);
        gp.getMON_Orc()[6].setWorldY(gp.getTileSize()*52);

        gp.getMON_Orc()[7] = new MON_Orc(gp);
        gp.getMON_Orc()[7].setWorldX(gp.getTileSize()*69);
        gp.getMON_Orc()[7].setWorldY(gp.getTileSize()*64);

        gp.getMON_Orc()[8] = new MON_Orc(gp);
        gp.getMON_Orc()[8].setWorldX(gp.getTileSize()*75);
        gp.getMON_Orc()[8].setWorldY(gp.getTileSize()*67);

        gp.getMON_Orc()[9] = new MON_Orc(gp);
        gp.getMON_Orc()[9].setWorldX(gp.getTileSize()*25);
        gp.getMON_Orc()[9].setWorldY(gp.getTileSize()*12);
